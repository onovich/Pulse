...
namespace MortiseFrame.Pulse.Sample {
    ...
    public static class GizmosHeler {
        ...
        public static void OnDrawBox(BoxShape box, TFComponent transform, Color color) {
        ...
        public static void OnDrawCircle(CircleShape circle, TFComponent transform, Color color) {
